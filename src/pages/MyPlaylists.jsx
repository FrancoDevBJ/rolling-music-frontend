...
const MyPlaylists = () => {
    ...
    const handleCreate = async (e) => {
        ...
        try {
            ...
            if (data.ok) {
                ...
                Swal.fire(
                    '¡Creada!',
                    'Tu nueva lista está lista para recibir música',
                    'success'
                );
            }
        } catch (error) {
    ...
    return (
        <div className="bg-gradient-to-b from-purple-900/20 to-black min-h-full p-8">
            ...
            {showModal && (
                ...
                <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/80 backdrop-blur-sm p-4">
                    ...
                    <form 
                        ...
                        className="bg-neutral-900 p-8 rounded-2xl border border-white/10 w-full max-w-sm shadow-2xl"
                    >
                        ...
                        <div className="flex gap-4">
                            ...
                            <button
                                type="submit"
                                className="flex-1 bg-violet-600 py-2 rounded-lg font-bold hover:bg-violet-500"
                            >
                                Crear
                            </button>
